    ...
    row.update(
        {
            ...
            "surface_quote_source": _safe_str(_extract(surface, "quote_source", ""), ""),
    ...
    row.update(
        {
            ...
            "surface_quote_source": _safe_str(_extract(recommendation, "surface_quote_source", ""), ""),
